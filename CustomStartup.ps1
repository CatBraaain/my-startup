...
RunAsync "Code" ' -ArgumentList "C:\Users\PRO\Documents\Projects\AutoHotkey" -WindowStyle Hidden' -WinTitle "*AutoHotkey - Visual Studio Code"
RunAsync "Code" ' -ArgumentList "C:\Users\PRO\Documents\Projects\MyChromeExtension" -WindowStyle Hidden' -WinTitle "*MyChromeExtension - Visual Studio Code"
RunAsync "Code" ' -ArgumentList "C:\Users\PRO\Documents\Projects\SeleniumProject" -WindowStyle Hidden' -WinTitle "*SeleniumProject - Visual Studio Code"
